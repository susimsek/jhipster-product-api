...
import {Account, AccountService, JhiLanguageHelper, StateStorageService} from 'app/core';
...
export class JhiMainComponent implements OnInit, OnDestroy {
  ...
  private getPageTitle(routeSnapshot: ActivatedRouteSnapshot) {
    let title: string = routeSnapshot.data && routeSnapshot.data['pageTitle'] ? routeSnapshot.data['pageTitle'] : 'productApp';
